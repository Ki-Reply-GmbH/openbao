...
go build -v -o "bin/${exe}" -tags=ui -buildvcs -trimpath -ldflags \
    "-X github.com/openbao/openbao/version.fullVersion=${VERSION#v} -X github.com/openbao/openbao/version.GitCommit=${commit} -X github.com/openbao/openbao/version.CommitDate=${commit_date}"
