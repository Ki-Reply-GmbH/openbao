...
func (h *RoleNoStoreFalse) DefaultConfig() map[string]any {
	return map[string]any{
		"allowed_roles": []string{},
	}
}

func (h *RoleNoStoreFalse) LoadConfig(config map[string]any) error {
	value, present := config["allowed_roles"].([]any)
	if present {
