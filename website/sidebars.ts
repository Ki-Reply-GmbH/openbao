...
const sidebars: SidebarsConfig = {
    ...
    api: [
        ...
        "api/relatedtools",
        {
            "Secret Engines": [
                "api/secret/index",
                "api/secret/cubbyhole",
                {
                    Databases: [
                        "api/secret/databases/index",
                        "api/secret/databases/cassandra",
                        "api/secret/databases/influxdb",
                        "api/secret/databases/mysql-maria",
                        "api/secret/databases/postgresql",
                        "api/secret/databases/valkey",
                    ],
                    Identity: [
                        "api/secret/identity/index",
                        "api/secret/identity/entity",
                        "api/secret/identity/entity-alias",
                        "api/secret/identity/group",
                        "api/secret/identity/group-alias",
                        "api/secret/identity/tokens",
                        "api/secret/identity/lookup",
                        "api/secret/identity/oidc-provider",
                        {
                            MFA: [
                                "api/secret/identity/mfa/index",
                                "api/secret/identity/mfa/duo",
                                "api/secret/identity/mfa/okta",
                                "api/secret/identity/mfa/pingid",
                                "api/secret/identity/mfa/totp",
                                "api/secret/identity/mfa/login-enforcement",
                            ],
                        },
                    ],
                    "Key/Value": [
            ...
            "System Backend": [
                "api/system/index",
                "api/system/audit",
                "api/system/audit-hash",
                "api/system/auth",
                "api/system/capabilities",
                "api/system/capabilities-accessor",
                "api/system/capabilities-self",
                "api/system/config-auditing",
                ...
                "api/system/in-flight-req",
                "api/system/init",
                "api/system/internal-counters",
                {
                    "/sys/internal/inspect": [
                        "api/system/inspect/index",
                        "api/system/inspect/request",
                        "api/system/inspect/router",
                    ],
                },
                "api/system/internal-specs-openapi",
                "api/system/internal-ui-mounts",
                "api/system/internal-ui-namespaces",
                "api/system/internal-ui-resultant-acl",
                "api/system/key-status",
                "api/system/ha-status",
                "api/system/leader",
                "api/system/leases",
                "api/system/loggers",
                "api/system/metrics",
                "api/system/mfa-validate",
                "api/system/monitor",
                "api/system/mounts",
                "api/system/namespaces",
                "api/system/plugins-reload-backend",
                "api/system/plugins-catalog",
                "api/system/policy",
                "api/system/policies",
                "api/system/policies-password",
                "api/system/pprof",
                "api/system/quotas-config",
                "api/system/rate-limit-quotas",
                "api/system/raw",
                "api/system/rekey",
                "api/system/rekey-recovery-key",
                "api/system/remount",
                {
                    "/sys/rotate": [
                        "api/system/rotate/index",
                        "api/system/rotate/keyring",
                        "api/system/rotate/keyring-config",
                        "api/system/rotate/root",
                        "api/system/rotate/init",
                        "api/system/rotate/update",
                        "api/system/rotate/verify",
                        "api/system/rotate/backup",
                    ],
                },
                "api/system/seal",
                "api/system/seal-status",
                "api/system/step-down",
                {
                    "/sys/storage": [
                        "api/system/storage/index",
                        "api/system/storage/raft",
                        "api/system/storage/raftautopilot",
                    ],
                },
                "api/system/tools",
                "api/system/unseal",
                "api/system/user-lockout",
                "api/system/version-history",
                "api/system/workflows",
                "api/system/wrapping-lookup",
                "api/system/wrapping-rewrap",
                "api/system/wrapping-unwrap",
                "api/system/wrapping-wrap",
            ],
        },
    ],
};
