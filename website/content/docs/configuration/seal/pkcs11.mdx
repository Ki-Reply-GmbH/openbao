...
This seal remains built-in in OpenBao v2.6.x, but will remain available only as
an external plugin starting v2.7.0.
...
expected that it is [seal-compatible](../../policies/migration.mdx); manual
