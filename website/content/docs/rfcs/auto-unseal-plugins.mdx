...
This change improves OpenBao's overall security posture by greatly reducing
the Go dependencies of the main OpenBao binary. Furthermore, in terms of
reliability, a panicking KMS plugin will not directly affect other processes or
cause the OpenBao instance to crash.
