...
// response.
func (b *RaftBackend) SnapshotHTTP(out *logical.HTTPResponseWriter, access seal.Wrapper) error {
...
func (b *RaftBackend) Snapshot(out io.Writer, access seal.Wrapper) error {
	b.l.RLock()
	defer b.l.RUnlock()
...
func (b *RaftBackend) WriteSnapshotToTemp(in io.ReadCloser, access seal.Wrapper) (*os.File, func(), raft.SnapshotMeta, error) {
	b.l.RLock()
	defer b.l.RUnlock()
