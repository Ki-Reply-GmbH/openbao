...
func (c *Core) enableCredential(ctx context.Context, entry *routing.MountEntry) error {
	...
	if err := c.enableCredentialInternal(ctx, entry, routing.MountTableUpdateStorage); err != nil {
		return err
	}
...
func (c *Core) disableCredential(ctx context.Context, path string) error {
	...
	if err := c.disableCredentialInternal(ctx, path, routing.MountTableUpdateStorage); err != nil {
		return err
	}
